...
| `docs/architecture/05-system-architecture.md` | End-state spec | Whole-system assembly: hub-and-spoke topology, component inventory, data flows, shared services, NFR targets. | Components C1–C19, flows F1–F5, topology, NFRs | End-state; not current behaviour |
